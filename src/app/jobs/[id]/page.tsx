...
const modalInputClass =
    "w-full mt-1 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 text-sm outline-none focus:ring-2 focus:ring-indigo-500";
...
export default function JobDetailsPage(): React.JSX.Element {
    ...
    // user লোড হলে নাম/ইমেইল auto-fill
    useEffect(() => {
        if (user) {
    ...
    const handleApplySubmit = async (e: React.FormEvent) => {
        ...
        if (!applicantName.trim() || !applicantEmail.trim() || !whyInterested.trim()) {
    ...
    if (loading) {
        return (
            <div className="min-h-screen pt-24 px-4 max-w-6xl mx-auto animate-pulse">
        ...
        <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                ...
                <div className="lg:col-span-1">
                    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-6 lg:sticky lg:top-24">
                        ...
                        {/* Add review form - উপরে */}
                        <form onSubmit={handleReviewSubmit} className="mb-5 pb-5 border-b border-gray-100 dark:border-gray-800">
                            ...
                            <button
                                ...
                                className="w-full px-5 py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-semibold hover:bg-indigo-700 transition-colors disabled:opacity-60"
                            >
            ...
            {showApplyModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
                    <div className="w-full max-w-lg bg-white dark:bg-gray-950 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 relative max-h-[90vh] overflow-y-auto">
                        <button
